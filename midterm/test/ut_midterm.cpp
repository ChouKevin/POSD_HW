...
TEST(Visitor,InitialAcceptWhenFunctionCall)
{
    ...
    ASSERT_NEAR(3.14159, complexShapes->getChild(0)->area(), 0.01);
    ASSERT_NEAR(8, complexShapes->getChild(1)->area(), 0.01);
    ASSERT_NEAR(12.5664, complexShapes->getChild(2)->area(), 0.01);
...
TEST(Visitor, FindAreaInNestedComposite)
{
    ...
    ASSERT_NEAR(3.14159, complexShapes->getChild(0)->area(), 0.01);
    ASSERT_NEAR(23.708, complexShapes->getChild(1)->area(), 0.01);
    ASSERT_NEAR(3.14159, complexShapes->getChild(1)->getChild(0)->area(), 0.01);
